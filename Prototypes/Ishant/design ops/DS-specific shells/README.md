...
These shells use Ishant’s shared design system at the workspace root, `design-system/`.
Read `../../AGENTS.md` and `../../../../design-system/AGENTS.md` before changing them.

`TitanEmailShell/` preserves the DS-connected email shell and its local assets.
...
it is not a standalone export. Registry screen previews and specimen assets point here.
