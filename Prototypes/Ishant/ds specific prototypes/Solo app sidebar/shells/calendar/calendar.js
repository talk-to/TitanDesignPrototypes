...
$('sidebar-header-host').outerHTML=TitanSidebarHeader.render({trigger:TitanAppSwitcherPattern.render(TitanAppSwitcherOptions('calendar')),logo:'../mail/assets/fa36f613-977c-444a-bef5-e1b5f5f1b340.svg'});
